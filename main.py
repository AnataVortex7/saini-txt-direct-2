...
AUTH_USER = os.environ.get('AUTH_USERS', '7268596608').split(',')
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        f"╭────────⊰◆⊱────────╮\n"   
        f" ➠ 𝐌𝐚𝐝𝐞 𝐁𝐲 : [𝗔𝗞𝗦𝗛𝗔𝗬 𝘽𝙊𝙏𝙎](https://t.me/saini_contact_bo) 💻\n"
        f"╰────────⊰◆⊱────────╯\n"
        )
    )                    
...
async def txt_handler(bot: Client, m: Message):  
    ...
    if raw_text3 == '1':
        CR = '[𝄟⃝‌🐬𝗔𝗞𝗦𝗛𝗔𝗬🐬](https://t.me/AnataVrtex7)'
    else:
        CR = raw_text3
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝗔𝗞𝗦𝗛𝗔𝗬 𝘽𝙊𝙏𝙎🐦](https://t.me/Anataortex7)"
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n" \
                           f"🛑**Send** /stop **to stop process**\n┃\n" \
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝗔𝗞𝗦𝗛𝗔𝗬 𝘽𝙊𝙏𝙎🐦](https://t.me/AnaaVortex7)"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n" \
                           f"🛑**Send** /stop **to stop process**\n┃\n" \
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝗔𝗞𝗦𝗛𝗔𝗬 𝘽𝙊𝙏𝙎🐦](https://t.me/AataVortex7)"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"**⚡Dᴏᴡɴʟᴏᴀᴅɪɴɢ Sᴛᴀʀᴛᴇᴅ...⏳**\n" \
                           f"🔗𝐋𝐢𝐧𝐤 » {url}\n" \
                           f"✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝗔𝗞𝗦𝗛𝗔𝗬 𝘽𝙊𝙏𝙎🐦](https://t.me/+MdZ2996M2G43MWFl)"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
                    res_file = await helper.download_and_decrypt_video(url, cmd, name, appxkey)  
                    filename = res_file  
                    await prog.delete(True)  
